...
class FacebookFactoryTest extends KernelTestCase
{
    ...
    /**
     * @return \Laelaps\Bundle\FacebookAuthentication\DependencyInjection\Security\Factory\FacebookFactory
     */
    private function getFacebookFactory()
    {
    ...
    public function testThatAuthenticationFailureHandlerIsCreated()
    {
        ...
        $facebookFactory = $this->getFacebookFactory();
        $providerKey = uniqid();
